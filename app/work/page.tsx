                                ...
                                <div className="col-lg-8 mx-lg-auto">
                                    <div className="text-center">
                                        ...
                                        <h3 className="ds-3 mt-3 mb-4 text-dark">
                                            חקור <span className="text-300">את העבודות האחרונות שלי וגלה את</span> המקצועיות מאחורי <span className="text-300">כל עיצוב</span>
                                        </h3>
												...
												<div className="card__content px-md-4 px-3">
													<div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
														<Link href="/work-single" className="card_title_link">
															...
															<h3 className="fw-semibold">עיצוב מחדש של אתר מסחר אלקטרוני</h3>
														</Link>
													...
													<p className="text-300 mb-lg-auto mb-md-4 mb-3">עוצבה פלטפורמת למידה אינטראקטיבית ומרתקת שמטרתה לשפר את חוויות הלמידה המקוונת. כלל זה פיתוח ניווט אינטואיטיבי, חומרי קורס אינטראקטיביים ותכונות התומכות במעורבות ושיתוף הסטודנטים.</p>
                                        ...
                                        <div className="card-custom" data-index={0}>
                                            <div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
                                                ...
                                                <div className="card__content px-md-4 px-3">
                                                    <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                                                        <Link href="/work-single" className="card_title_link">
                                                            <p className="text-primary-1 mb-0 mb-md-2">עיצוב אפליקציה</p>
                                                            <h3 className="fw-semibold">UI/UX לאפליקציית כושר</h3>
                                                        </Link>
                                                        <Link href="/work-single" className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
                                                            <i className="ri-arrow-right-up-line" />
                                                        </Link>
                                                    ...
                                                    <p className="text-300 mb-lg-auto mb-md-4 mb-3">עוצבה פלטפורמת למידה אינטראקטיבית ומרתקת שמטרתה לשפר את חוויות הלמידה המקוונת. כלל זה פיתוח ניווט אינטואיטיבי, חומרי קורס אינטראקטיביים ותכונות התומכות במעורבות ושיתוף הסטודנטים.</p>
                                                    <div className="d-md-flex content">
                                                        <p className="mb-0 fs-7 text-dark text-uppercase w-40">לקוח</p>
                                                        <p className="mb-0 card__description text-300 fs-6 mb-0">Conceptual JSC</p>
                                                    </div>
                                                    <div className="d-md-flex content">
                                                        <p className="mb-0 fs-7 text-dark text-uppercase w-40">זמן השלמה</p>
                                                        <p className="mb-0 card__description text-300 fs-6 mb-0">6 months</p>
                                                    </div>
                                                    <div className="d-md-flex content">
                                                        <p className="mb-0 fs-7 text-dark text-uppercase w-40">כלים</p>
                                        ...
                                        <div className="card-custom" data-index={0}>
                                            <div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
                                                ...
                                                <div className="card__content px-md-4 px-3">
                                                    <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                                                        <Link href="/work-single" className="card_title_link">
                                                            <p className="text-primary-1 mb-0 mb-md-2">פיתוח ווב</p>
                                                            <h3 className="fw-semibold">פלטפורמת הזמנת נסיעות</h3>
                                                        </Link>
                                                        <Link href="/work-single" className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
                                                            <i className="ri-arrow-right-up-line" />
                                                        </Link>
                                        ...
                                        <div className="card-custom" data-index={0}>
                                            <div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
                                                ...
                                                <div className="card__content px-md-4 px-3">
                                                    <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                                                        <Link href="/work-single" className="card_title_link">
                                                            <p className="text-primary-1 mb-0 mb-md-2">עיצוב ויזואלי</p>
                                                            <h3 className="fw-semibold">UI/UX לפלטפורמת למידה</h3>
                                                        </Link>
                                                        <Link href="/work-single" className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
                                                            <i className="ri-arrow-right-up-line" />
                                                        </Link>
