		...
		<>
			...
			<div className="container">
				<div className="text-start">
					...
					<button className={activeBtn("*")} onClick={handleFilterKeyChange("*")}>כל הפרויקטים</button>
					<button className={activeBtn("brand")} onClick={handleFilterKeyChange("brand")}>מיתוג</button>
					<button className={activeBtn("webdesign")} onClick={handleFilterKeyChange("webdesign")}>עיצוב אתרים</button>
					<button className={activeBtn("ui")} onClick={handleFilterKeyChange("ui")}>UI/UX</button>
					<button className={activeBtn("app")} onClick={handleFilterKeyChange("app")}>פיתוח אפליקציות</button>
					</div>
				</div>
				<div className="row masonry-active justify-content-between mt-6">
					...
					<div className="filter-item col-lg-6 col-12 brand ui app">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<Link href="/work-single" className="project-card-content">
								<h3 className="fw-semibold">אפליקציית צילום UI/UX</h3>
								<p>רשת Bokeh</p>
							</Link>
					...
					<div className="filter-item col-lg-6 col-12 webdesign brand dataanalysis brand">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
							<Link href="/work-single" className="project-card-content">
								<h3 className="fw-semibold">עיצוב אפליקציית מובייל</h3>
					...
					<div className="filter-item col-lg-6 col-12 ui app">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
							<Link href="/work-single" className="project-card-content">
								<h3 className="fw-semibold">עיצוב אינטראקטיבי</h3>
					...
					<div className="filter-item col-lg-6 col-12 app app dataanalysis brand">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
							<Link href="/work-single" className="project-card-content">
								<h3 className="fw-semibold">ייעוץ עיצובי</h3>
