                ...
                <div className="container">
                    <div className="row">
                        <div className="text-center mb-7">
                            <h3 className="ds-3 mt-3 mb-3 text-primary-1">הכישורים שלי</h3>
                            <span className="fs-5 fw-medium text-200">
                                אני משגשג בהמרת בעיות מורכבות לפתרונות פשוטים ויפים
                                <br className="d-md-block d-none" />
                                שמשפרים את שביעות רצון המשתמשים.
                            </span>
                        </div>
                        ...
                        <div className="text-center">
                            <p className="fs-5 text-200 mb-0">בנוסף, יש לי ידע תכנותי כגון: </p>
