						...
						<div className="box-linear-animation position-relative z-1">
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								<div className="d-flex align-items-center">
									...
									<span className="text-linear-4 d-flex align-items-center"> פרויקטים </span>
								</div>
								<h3>העבודות האחרונות שלי</h3>
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<p>פיתוח פלטפורמת למידה מקוונת עם ניהול קורסים, חידונים ומעקב התקדמות.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">פרטי הפרויקט</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">לקוח</p>
																		<p className="text-300 mb-0 text-end">Conceptual JSC</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">זמן השלמה</p>
																		<p className="text-300 mb-0 text-end">6 חודשים</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">טכנולוגיות</p>
