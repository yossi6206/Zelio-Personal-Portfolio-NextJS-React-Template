								...
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">שנות ניסיון</p>
										</div>
									</div>
								</div>
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">פרויקטים הושלמו</p>
										</div>
									</div>
								</div>
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">לקוחות מרוצים</p>
										</div>
									</div>
								</div>
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">זוכה פרסים</p>
										</div>
									</div>
								</div>
							</div>
