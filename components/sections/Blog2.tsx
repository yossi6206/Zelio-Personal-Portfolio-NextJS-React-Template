                ...
                <div className="container">
                    <div className="text-center">
                        <div className="d-flex align-items-center justify-content-center">
                            ...
                            <span className="text-linear-4 d-flex align-items-center"> פוסטים אחרונים </span>
                        </div>
                        <h3>מהבלוג</h3>
                    </div>
                    <div className="row mt-8">
                        ...
                        <div className="col-lg-4">
							<div className="blog-card rounded-top-2 mb-lg-3 mb-md-5 mb-3">
								...
								<div className="blog-card__content position-relative text-center mt-4">
									...
									<h6 className="blog-card__title mt-2">אופטימיזציה של אפליקציית הווב שלך למהירות</h6>
									<p className="blog-card__description fs-7">הישאר מעודכן עם מגמות עולות אלו בעיצוב UI/UX.</p>
                        ...
                        <div className="col-lg-4">
                            <div className="blog-card rounded-top-2 mb-lg-3 mb-md-5 mb-3">
                                ...
                                <div className="blog-card__content position-relative text-center mt-4">
                                    <span className="blog-card__date fs-7">28 במרץ, 2026 • 3 דקות קריאה</span>
                                    <h6 className="blog-card__title mt-2">שיטות עבודה מומלצות לפיתוח ווב מאובטח</h6>
                                    <p className="blog-card__description fs-7">הישאר מעודכן עם מגמות עולות אלו בעיצוב UI/UX.</p>
                                    <Link href="#" className="link-overlay position-absolute top-0 start-0 w-100 h-100" />
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4">
                            <div className="blog-card rounded-top-2 mb-lg-3 mb-md-5 mb-3">
                                ...
                                <div className="blog-card__content position-relative text-center mt-4">
                                    <span className="blog-card__date fs-7">28 במרץ, 2026 • 3 דקות קריאה</span>
                                    <h6 className="blog-card__title mt-2">10 פריימוורקים של JavaScript לפיתוח ווב ב-2026</h6>
                                    <p className="blog-card__description fs-7">הישאר מעודכן עם מגמות עולות אלו בעיצוב UI/UX.</p>
                                    <Link href="#" className="link-overlay position-absolute top-0 start-0 w-100 h-100" />
                                </div>
                            </div>
