									...
									<div className="row g-4">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">פתרונות מסחר אלקטרוני</h6>
												<p className="fs-7 text-300 fw-regular">פיתוח פתרונות תשלום סקלאביליים ומאובטחים <span className="text-secondary-2">לפלטפורמות מסחר אלקטרוני</span> המותאמים לצרכי העסק שלך.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">שילוב AI</h6>
												<p className="fs-7 text-300 fw-regular">שפר את האפליקציות שלך עם AI לשיפור יעילות, אוטומציה וחוויית משתמש</p>
											</div>
										</div>
									</div>
