							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										...
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">עם מומחיות בטכנולוגיות חדשניות כגון</span> <span className="text-secondary-2">NodeJS</span>, <span className="text-secondary-2">React</span>, <span className="text-secondary-2">Angular</span>, <span className="text-secondary-2">Laravel</span><span className="text-dark">...אני מספק פתרונות ווב חדשניים ואיתנים כאחד.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
											...
											<div className="col-5 d-flex align-items-end">
												<span className="fs-6 text-300 mb-2">...ועוד</span>
											</div>
										</div>
