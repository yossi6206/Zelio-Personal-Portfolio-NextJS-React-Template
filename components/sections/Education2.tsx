							...
							<div className="rounded-3 border border-1 position-relative h-100 overflow-hidden">
								<div className="box-linear-animation p-md-6 p-3 ">
									<div className="d-flex align-items-center">
										...
										<h2 className="mb-0 ms-2">השכלה</h2>
									</div>
											...
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														...
														<p className="text-dark">הסמכה ב-React ו-Redux, קורס מפתח Node.js</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														...
														<p className="text-dark">הסמכה בפיתוח ווב Full Stack</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
								<div className="d-flex align-items-center">
									...
									<h2 className="mb-0 ms-2">מחקר</h2>
								</div>
								<div className="d-flex flex-column h-100 position-relative mt-5">
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">אנליטיקת נתונים מתקדמת עם כלי Big Data</span>
													<p className="text-dark">שימוש בכלי Big Data לאנליטיקה מתקדמת ותובנות.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">ארכיטקטורות יישומים מותאמות ל-Cloud</span>
													<p className="text-dark">חקר שיטות עבודה מומלצות לתכנון יישומים מותאמי ענן.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">התאמה אישית של חוויית המשתמש מבוססת AI</span>
													<p className="text-dark">ניצול AI להתאמה אישית של חוויות משתמש על בסיס התנהגות.</p>
												</div>
											</div>
										</li>
									</ul>
