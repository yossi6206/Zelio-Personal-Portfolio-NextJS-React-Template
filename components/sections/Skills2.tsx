							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> מיומנויות </span>
									</div>
									<h3>המיומנויות שלי</h3>
								</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">חזית:</p>
																	<span className="text-300">HTML, CSS, JavaScript, React, Angular</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">צד שרת:</p>
																	<span className="text-300">Node.js, Express, Python, Django</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">מסדי נתונים:</p>
																	<span className="text-300">MySQL, PostgreSQL, MongoDB</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">כלים ופלטפורמות:</p>
																	<span className="text-300">Git, Docker, AWS, Heroku</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">אחר:</p>
