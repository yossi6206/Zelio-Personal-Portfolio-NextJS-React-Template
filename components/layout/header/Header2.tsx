								...
								<div className="d-none d-lg-flex">
									...
									<ul className="navbar-nav me-auto mb-2 mb-lg-0">
										<li className="nav-item">
											<Link className="nav-link active" href="#about">אודותי</Link>
										</li>
										<li className="nav-item">
											<Link className="nav-link" href="#resume">קורות חיים</Link>
										</li>
										<li className="nav-item">
											<Link className="nav-link" href="#services">שירותים</Link>
										</li>
										<li className="nav-item">
											<Link className="nav-link" href="#portfolio">תיק עבודות</Link>
										</li>
										<li className="nav-item">
											<Link className="nav-link" href="#blog">בלוג</Link>
										</li>
										<li className="nav-item">
