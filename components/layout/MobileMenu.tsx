				...
				<div className="mobile-header-wrapper-inner">
					<div className="mobile-header-logo">
						<Link className="d-flex main-logo align-items-center d-inline-flex" href="/">
							...
							<span className="fs-4 ms-2 text-dark">allintech</span>
						</Link>
							...
							<div className="mobile-menu-wrap mobile-header-border">
								...
								<ul className="mobile-menu font-heading ps-0">
									<li className="nav-item">
										<Link className="nav-link active" href="/">בית</Link>
									</li>
									<li className="nav-item">
										<Link className="nav-link" href="/services">שירותים</Link>
									</li>
									<li className="nav-item">
										<Link className="nav-link" href="/work">תיק עבודות</Link>
									</li>
									<li className="nav-item">
										<Link className="nav-link" href="/pricing">מחירים</Link>
									</li>
									<li className="nav-item">
										<Link className="nav-link" href="/blog-list">בלוג</Link>
									</li>
									<li className="nav-item">
										<Link className="nav-link" href="/#contact">צור קשר</Link>
									</li>
								</ul>
								</nav>
							</div>
